...
Installing Python 3.12 on Debian
---------------------------------
...
::
    ...
    python3.12 -m pip install virtualenvwrapper
...
Create a virtual environment using Python 3.12 (the same command will take you to a virtual environment):

::

    mkvirtualenv --python=/usr/local/bin/python3.12 pyneng-py3
